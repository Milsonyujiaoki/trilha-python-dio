...
# Função para validar o valor do depósito/saque
...
# Função para o cliente escolher entre suas contas
def escolher_conta(cliente):
    ...
    while True:
        try:
            ...
            print("@@@ Entrada inválida, por favor insira o número da conta. @@@")
...
def depositar(clientes):
    ...
    if not validar_valor(valor):
        print("\n@@@ Valor inválido! Deve ser um número positivo. @@@")
        return

    transacao = Deposito(float(valor))
